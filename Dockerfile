...
ARG FEISHU_TYPE_TABLE_ID
ARG FEISHU_CONTENT_TABLE_ID
ARG FEISHU_DETAIL_TABLE_ID
ARG FEISHU_RECORD_TABLE_ID
...
ENV FEISHU_TYPE_TABLE_ID=$FEISHU_TYPE_TABLE_ID
ENV FEISHU_CONTENT_TABLE_ID=$FEISHU_CONTENT_TABLE_ID
ENV FEISHU_DETAIL_TABLE_ID=$FEISHU_DETAIL_TABLE_ID
ENV FEISHU_RECORD_TABLE_ID=$FEISHU_RECORD_TABLE_ID
